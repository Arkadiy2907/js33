...
// Spaghetti code - много пропдлиллинга
// Magic numbers - непонятные числа в коде
// Изобретение колеса/велосипеда - есть уже готовые протестированные решения
// God Object - Объект берет на себя слишком много обязанностей
// Boat anchor - нигде не используемые старые куски кода) "на будущее".
